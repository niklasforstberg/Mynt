...
namespace Mynt.Migrations
{
    ...
    [Migration("20250727191359_AlterTableAssetTypeAddIsLiquid")]
    partial class AlterTableAssetTypeAddIsLiquid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mynt.Models.PortfolioSnapshot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AssetSummary")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("DebtSummary")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int?>("FinancialGroupId")
                        .HasColumnType("int");

                    b.Property<decimal?>("GroupAssetSummary")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("GroupDebtSummary")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("GroupPercentageChange")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("GroupTotalSummary")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Mynt.Models.SnapshotConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ChangeThreshold")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("SnapshotConfigurations");
                });
            ...
            modelBuilder.Entity("Mynt.Models.SnapshotConfiguration", b =>
                {
                    b.HasOne("Mynt.Models.User", "User")
                        .WithOne("SnapshotConfiguration")
                        .HasForeignKey("Mynt.Models.SnapshotConfiguration", "UserId");
            ...
            modelBuilder.Entity("Mynt.Models.User", b =>
                {
                    ...
                    b.Navigation("SnapshotConfiguration");
                });
